...
function ModelRow({ model, onRun, onEdit, onDelete }) {
  return (
    <tr className="hover:bg-slate-50 transition-colors">
      ...
      <td className="px-6 py-4 text-sm text-slate-600">{model.provider}</td>
      <td className="px-6 py-4">
      ...
      <td className="px-6 py-4 text-sm text-slate-600">{model.requests}</td>
      <td className="px-6 py-4 text-sm text-slate-600">{model.latency}</td>
      <td className="px-6 py-4 text-sm text-slate-600">{model.cost}</td>
      <td className="px-6 py-4">
